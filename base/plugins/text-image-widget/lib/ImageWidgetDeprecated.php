...
class ImageWidgetDeprecated {
	...
	function admin_setup() {
		...
		if ( 'widgets.php' == $pagenow ) {
			...
			wp_enqueue_script( 'tribe-image-widget', IMAGE_WIDGET_URI.'resources/js/image-widget.deprecated.js', array('thickbox'), Tribe_Image_Widget::VERSION, TRUE );
		}
		elseif ( 'media-upload.php' == $pagenow || 'async-upload.php' == $pagenow ) {
			wp_enqueue_script( 'tribe-image-widget-fix-uploader', IMAGE_WIDGET_URI.'resources/js/image-widget.deprecated.upload-fixer.js', array('jquery'), Tribe_Image_Widget::VERSION, TRUE );
